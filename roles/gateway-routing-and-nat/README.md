# Intro [![Build Status](https://travis-ci.org/triplepoint/ansible-gateway-routing-and-nat.svg?branch=master)](https://travis-ci.org/triplepoint/ansible-gateway-routing-and-nat)
